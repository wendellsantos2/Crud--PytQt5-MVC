...
class Ui_TelaAlterarAdm(object):
    ...
    def setupUi(self, MainWindow):
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_product.setItemDelegateForColumn(3,MyDelegate())
...
"")
        ...
        self.btn_atualizar.clicked.connect(lambda:self.usuario_criar_controller.atualizar_usuario())
